...
const Footer: FC = () => {
   ...
   const handleEmailClick = () => {
      window.location.href = 'mailto:chihtengma416@gmail.com';
   };
         ...
         <div className="container">
            <div className="section">
               <div className="flex items-center gap-3">
                  ...
                  <span className="uppercase">Available for immediate work opportunities</span>
               </div>
               <div className="grid md:grid-cols-3 md:items-center">
                  <div className="md:col-span-2">
                     <h2 className="mt-8 text-4xl font-extralight md:text-7xl lg:text-8xl" ref={scope}>
                        Enough talk. Let&apos; build something great together.
                     </h2>
                     <Button
                        variant="secondary"
                        className="mt-8"
                     ...
                     <div className="mt-6 flex gap-4">
                        ...
                        <a
                           href="https://linkedin.com/in/chihtengma"
                           target="_blank"
                           rel="noopener noreferrer"
                           className="text-white/70 hover:text-white transition-colors"
                        >
            ...
            <p className="py-16 text-sm text-white/30">
               Copyright &copy; ChihTeng Ma &bull; All rights reserved
            </p>
         </div>
      </footer>
   );
